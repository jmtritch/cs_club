class TicTacToe():
    ...
    def check_winner(self) -> bool:
        ...
        # Check rows
        if self.board[0] == self.board[1] == self.board[2] is not None:
            return True
        if self.board[3] == self.board[4] == self.board[5] is not None:
            return True
        if self.board[6] == self.board[7] == self.board[8] is not None:
            return True

        # Check columns
        if self.board[0] == self.board[3] == self.board[6] is not None:
            return True
        if self.board[1] == self.board[4] == self.board[7] is not None:
            return True
        if self.board[2] == self.board[5] == self.board[8] is not None:
            return True
    ...
    def get_user_play(self) -> int:
        ...
        while not acceptable:
            ...
            if (len(cell_id) == 1
               and cell_id >= '1'
               and cell_id <= '9'
               and self.board[int(cell_id)-1] is None):
                acceptable = True
